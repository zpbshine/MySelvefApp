...
extern "C"
{
    ...
    JNIEXPORT jstring JNICALL Java_com_example_administrator_myselvefapp_Activity_LoginActivity_getFromJNI(JNIEnv *env, jobject obj ){
       // 参数说明
