...
public class ZipUtils {
    ...
    public static void UnZipFolder(String zipFileString, String outPathString) throws Exception {
        ...
        System.out.println("inZip====="+inZip.toString());
        ZipEntry zipEntry;
        String szName = "";
        System.out.println("111====="+inZip.getNextEntry());
        while ((zipEntry = inZip.getNextEntry()) != null) {
            szName = zipEntry.getName();
            System.out.println("222====="+zipEntry.isDirectory()+"===="+szName);
            if (zipEntry.isDirectory()) {
                ...
                System.out.println("333====="+file.exists());
                if (!file.exists()) {
